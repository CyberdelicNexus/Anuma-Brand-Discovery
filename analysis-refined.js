(() => {
  ...
  const COPY_EDIT_KEY = "anuma-analysis-copy-edits-v2-refined";
  ...
  const signalDefinitions = [
    {
      ...
      description: "Every respondent frames the value through connection, community, collective experience or relationship, even when each person explains it differently.",
    ...
    },
    {
      ...
      description: "Preparation, consent, facilitation and integration repeatedly appear as core product requirements, not as support content.",
    ...
    {
      title: "The business model is unresolved",
      strength: "open",
  ...
  const tensions = [
    { left: "Scale", right: "Safeguarding", bridge: "Scale the care, not just the access", stake: "Solo delivery is how aNUma pays its way. The potency of the work makes safety protocols just as necessary.", fields: ["soloPathway", "impact", "claim"] },
    ...
    { left: "Mystery", right: "Immediate clarity", bridge: "Explain the way in. Leave the experience unexplained.", stake: "Be clear about what, who, how and how much. Stay quiet about what people should feel.", fields: ["risk", "launchPriority", "sample"] },
  ];
  ...
  const contemplationPrompts = [
    ...
    },
    {
      ...
      synthesis: "The numadelic world is powerful because it remains suggestive: luminous, diffuse and weakly representational. The brand should keep that openness while making the way in obvious.",
    ...
    const comparisonCards = [
      {
        ...
        detail: largestDelta ? `Team mean ${largestDelta.teamMean.toFixed(1)}; your response ${largestDelta.strategistValue}. A difference is not an error. Look at why it exists.` : "Complete the expression section to compare your calibration.",
      },
      {
